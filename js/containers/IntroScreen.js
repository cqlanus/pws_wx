...
import { fetchUserLocation, getForecast, getDeviceData } from '../actions'
        ...
        return (
            <View style={styles.container}>
                <View style={styles.logoBackground}>
                    <Image
                        source={require('../../assets/images/iso-logo.png')}
                    />
                </View>
                ...
                <StyledText style={styles.instructions}>
                    To get started, edit <MonoText>index.js</MonoText>,{' '}
                    <MonoText>App.js</MonoText>, and the files in{' '}
                    <MonoText>js/</MonoText>.
                </StyledText>
                <StyledText style={styles.instructions}>
                ...
                <View style={styles.footer}>
                    ...
                    {this.props.encouragementVisible &&
                        !this.props.error && (
                            <SpringAppearAnimation>
                                <StyledText style={styles.welcome}>
                                    {this.props.location.city},{' '}
                                    {this.props.location.region}
                                </StyledText>
                            </SpringAppearAnimation>
                        )}
                    {this.props.error && (
...
const mapStateToProps = state => {
    return {
        ...
        encouragementVisible:
            ...
            state.location.result !== undefined,
